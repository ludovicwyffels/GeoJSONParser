(function(GeoJSONParser) {
  ...
  GeoJSONParser.parse = function(objects, params, callback) {
    var geojson,
  ...
  function buildGeom(item, params) {
    ...
    if(params.doThrows && params.doThrows.invalidGeometry && !GeoJSONParser.isGeometryValid(geom)){
